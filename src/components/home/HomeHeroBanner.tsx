...
export default function HomeHeroBanner() {
  ...
  // Home & Living-specific banners
  const homeBanners: BannerType[] = [
    {
      id: "home-1",
      image: "/lovable-uploads/dd1cad7b-c3b6-43a6-9bc6-deb38a120604.png",
      type: "image",
      alt: "Home Decor & Furniture",
      position: 0,
      duration: 6000
    },
    {
  ...
  const getCurrentSlideDuration = () => {
    const slide = homeBanners[activeIndex];
  ...
  }, [activeIndex, homeBanners.length, videoDurations]);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const currentSlide = homeBanners[activeIndex];
  ...
  }, [activeIndex, homeBanners, showFloatingVideo]);
  ...
  return (
    <>
      ...
      >
        ...
        />
        <BannerControls
          slidesCount={homeBanners.length}
          activeIndex={activeIndex}
          previousIndex={previousIndex}
