...
export default function ElectronicsHeroBanner() {
  ...
  // Electronics-specific banners
  const electronicsBanners: BannerType[] = [
    {
      id: "electronics-1",
      image: "/lovable-uploads/2102d3a1-ec6e-4c76-8ee0-549c3ae3d54e.png",
      type: "image",
      alt: "Latest Smartphones & Gadgets",
      position: 0,
      duration: 5000
    },
    {
  ...
  const getCurrentSlideDuration = () => {
    const slide = electronicsBanners[activeIndex];
  ...
  useEffect(() => {
    if (electronicsBanners.length <= 1) return;
    ...
    const startSlideTimer = () => {
      ...
      timeoutRef = setTimeout(() => {
        ...
        setActiveIndex((current) => (current + 1) % electronicsBanners.length);
      }, duration);
    };
  ...
  }, [activeIndex, electronicsBanners.length, videoDurations]);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const currentSlide = electronicsBanners[activeIndex];
  ...
  }, [activeIndex, electronicsBanners, showFloatingVideo]);
  ...
  return (
    <>
      ...
      >
        ...
        />
        <BannerControls
          slidesCount={electronicsBanners.length}
          activeIndex={activeIndex}
          previousIndex={previousIndex}
